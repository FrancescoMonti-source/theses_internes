...
```{r}
data %>%
        mutate(sero_vih_t1 = ifelse(is.na(sero_vih_t1),0,sero_vih_t1),
...
```{r}
data %>% select(id,vhb_traitement,vhd_traitement_1) %>% filter(vhd_traitement_1!="Non traité" & vhb_traitement=="Non traité") %>% view
