...
# 
# 
# save_editable_plot(p, "Tableau de contingence protocole ODMF vs croissance du maxillaire")
...
Statistique de test (W) : La valeur W=102 est la statistique de test pour le test de somme des rangs de Wilcoxon. Elle représente la somme des rangs de l'un des deux groupes.
